...
public class BaseStatus
{
    ...
    public EquipmentType.DATA equipment_value = new EquipmentType.DATA();
    public BatteryType.DATA battery_status = new BatteryType.DATA();
    ...
    { STACK_TRUE, STACK_MAX, ALL_STACK_MAX }
    ...
    {
        equipment_value = new EquipmentType.DATA();
    }
    ...
    {
        battery_status = new BatteryType.DATA();
    }
