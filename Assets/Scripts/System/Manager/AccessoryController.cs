...
public class AccessoryController : MonoBehaviour
{
    ...
    public void SetEquipmentSlot(AccessorySO.ACCESSORY_STATUS _value, int _slotNo)
    {
        EquipmentManager.instance.GetRobotStatus().accessories_value[_slotNo] = _value;
        accessorySlots[_slotNo].SetText_AccessoryValue(_value);
    }
